...
export const EditPokemon = () => {
        ...
        const informacion = useSelector(Store => Store.PerfilReducer.persona)
        const update= useSelector(Store => Store.Asignador_data.update)

        const params = useParams()
        //const [prueba, setPrueba] = useState([useSelector(Store => Store.PerfilReducer.persona.name), "Si"])
        ...
        useEffect(()=>{
            dispatch(PokeEdit(`http://localhost:5000/results/${params.id}`));
            console.log(!update)
                ...
                {informacion != null ? (
                    ...
                    <div className='append'>
                            ...
                            <form onSubmit={handleSubmit}>
                                <h5 className='fuente centrado'>Enter the new data for {informacion.name}</h5>
